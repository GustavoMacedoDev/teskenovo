...
import br.com.macedo.sistemas.bean.ItensPedidoFacade;
...
public class ItensPedidoController implements Serializable {
    ...
    @EJB
    private br.com.macedo.sistemas.bean.ItensPedidoFacade ejbFacade;
    ...
    public ItensPedido getItensPedido(java.lang.Long id) {
    ...
    public static class ItensPedidoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ItensPedido) {
                ...
                return getStringKey(o.getIdItensPedido());
            } else {
